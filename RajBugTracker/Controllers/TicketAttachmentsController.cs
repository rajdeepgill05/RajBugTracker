...
namespace RajBugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Description,UserName,FilePath,FileUrl,Created")] TicketAttachment ticketAttachment)
        {
            ...
            ViewBag.TicketId = new SelectList(db.Tickets, "Id", "Name", ticketAttachment.TicketId);
            ViewBag.UserId = new SelectList(db.Users, "Id", "UserName", ticketAttachment.UserId);
            return View(ticketAttachment);
        }
